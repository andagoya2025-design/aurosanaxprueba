/***********************************************************************
 ...
 Versión: 1.2.0 - institucional premium, contexto clínico real
 Fecha: 2026-08-12
 -----------------------------------------------------------------------
  ...
  return `<div class="ac-paper" style="--ac-color:${esc(color)}">
    <div class="ac-doc-head">
      ...
      <div>
        ...
        ${cfg.subtitulo?`<div class="ac-brand-sub">${esc(cfg.subtitulo)}</div>`:''}
        ${ubicacion?`<div class="ac-brand-sub">${esc(ubicacion)}</div>`:''}
      </div>
...
.ac-paper{width:100%;min-height:270mm;padding:0;background:#fff}
.ac-doc-head{display:grid;grid-template-columns:auto 1fr auto;gap:12px;align-items:center;border-bottom:2.5px solid var(--ac-color,#8b1e5a);padding-bottom:9px}
.ac-logo-wrap{width:55px;height:55px;display:grid;place-items:center;overflow:hidden}.ac-logo{max-width:100%;max-height:100%;object-fit:contain}
.ac-brand{font-size:19px;font-weight:950;color:var(--ac-color,#8b1e5a);letter-spacing:.035em}.ac-brand-sub{font-size:10px;color:#667085;margin-top:2px}.ac-doc-date{text-align:right;font-size:11px;font-weight:750}
...
.ac-cert-lines{display:grid;gap:6px;margin:14px 0}.ac-cert-line{font-size:12px;line-height:1.42}.ac-cert-line b:first-child{display:inline-block;min-width:150px}
.ac-dx-doc{margin:14px 0 16px}.ac-dx-doc-title{font-size:12px;font-weight:900;margin-bottom:5px}.ac-dx-doc-row{font-size:12px;line-height:1.45}
.ac-reposo{margin-top:16px}.ac-reposo-row{font-size:12.1px;line-height:1.5;margin-top:4px}
.ac-firma-area{display:grid;grid-template-columns:1fr .9fr;gap:22px;align-items:end;margin-top:44px}.ac-centro-contacto{font-size:10.2px;color:#475569;line-height:1.45}.ac-sign{text-align:center;font-size:11.2px}.ac-sign-line{border-top:1px solid #111;margin-bottom:6px}.ac-sign b{font-size:12.4px}
@media print{
  html,body{width:210mm!important;min-height:297mm!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
  .ac-paper{page-break-inside:avoid!important}
}`;
}
