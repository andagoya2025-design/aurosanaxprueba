...
(function () {
  ...
  const VERSION = '20260717_ginecologia_v1';
  ...
  function antecedentesDesdeSistema() {
    const h = window.historiaActiva || window.historiaActual || window.currentHistoria || {};
  ...
  async function cargar(forzar=false) {
    ...
    cargando=true;
    try {
      const c=contextoActual(); pintarContexto(c); cargarAntecedentes();
