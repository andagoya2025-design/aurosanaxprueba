    ...
    return `
      <div class="auro-receta-documento ${esAdministrativo ? 'modo-administrativo' : 'modo-paciente'} ${esMultidiagnosticoPaciente ? 'auro-receta-multi' : 'auro-receta-single'}">
        <style>
          ...
          .modo-paciente.auro-receta-multi .auro-receta-grid{grid-template-columns:minmax(0,1.25fr) minmax(0,.95fr) minmax(0,.92fr) minmax(0,.78fr) minmax(0,1.05fr) minmax(0,1.05fr) minmax(0,1.10fr) minmax(0,1.15fr) minmax(0,1.15fr);align-items:start;gap:0;background:#fff;border:0;border-bottom:1px solid #cbd5e1;border-radius:0;padding:0 0 6px;margin-bottom:8px}
          ...
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-cedula{grid-column:3/4}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-genero{grid-column:4/5}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-edad{grid-column:5/6}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-fecha{grid-column:6/8}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-numero{grid-column:8/10;border-right:0}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-especialidad{grid-column:1/4;border-top:1px solid #eef2f7;margin-top:2px;padding-top:5px}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-medico{grid-column:4/7;border-top:1px solid #eef2f7;margin-top:2px;padding-top:5px}
          .modo-paciente.auro-receta-multi .auro-receta-grid .auro-rx-registro{grid-column:7/10;border-top:1px solid #eef2f7;margin-top:2px;padding-top:5px;border-right:0}
          .modo-paciente.auro-receta-multi .auro-receta-grid span{font-size:8px;margin-bottom:1px}
          .modo-paciente.auro-receta-multi .auro-receta-grid b{font-size:10px;line-height:1.16}
          .modo-paciente.auro-receta-multi .auro-rx-paciente b{white-space:normal;overflow-wrap:anywhere}
          .modo-paciente.auro-rx-genero b{white-space:nowrap;font-size:9.8px!important}
          .modo-paciente .auro-rx-numero b{white-space:nowrap!important;overflow-wrap:normal!important;word-break:normal!important;font-size:9.6px!important;letter-spacing:-.03em}
